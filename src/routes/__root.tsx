    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-xl px-5 py-2.5 text-sm font-bold text-white smooth press hover:-translate-y-0.5"
  ...
  head: () => ({
    meta: [
      ...
      { name: "twitter:description", content: "Plataforma de Trading Inteligente com IA" },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/cf1188c3-f21a-44f9-82cc-3675a6a0b96d/id-preview-75a31cc7--cc59ffa7-1796-4909-b6c2-936c23552622.lovable.app-1778852489149.png",
      },
      {
        name: "twitter:image",
        content:
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        // Inter: troca o peso 300 (0 usos no app) por 900 — font-black é
        // usado 41× e antes era sintetizado (faux-bold) por faltar o peso real.
