...
const BENEFITS = [
  {
    ...
    desc: "Sem limite no OrionScan — analise quantos gráficos quiser por dia.",
  },
  {
    Icon: BrainCircuit,
    title: "OrionMind sem restrição",
    desc: "Mentor IA 24/7 com memória estendida das suas operações.",
  },
  {
    Icon: LineChart,
    title: "Relatórios avançados",
    desc: "Métricas profissionais e exportação de gráficos em PNG e PDF.",
  },
  {
    Icon: Newspaper,
    title: "Notícias & Calendário",
    desc: "Eventos econômicos por impacto (alto, médio, baixo) em tempo real.",
  },
  {
    Icon: Bitcoin,
    title: "CryptoBubbles",
    desc: "Radar do mercado cripto integrado direto na plataforma.",
  },
  {
    Icon: Zap,
    title: "Prioridade de processamento",
    desc: "Suas análises rodam primeiro, mesmo nos horários de pico.",
  },
  {
    Icon: Gem,
    title: "Acesso antecipado",
    desc: "Novos módulos e estratégias liberados antes de todos.",
  },
  {
    Icon: ShieldCheck,
    title: "Suporte prioritário",
    desc: "Atendimento humano direto, com resposta em horas e não dias.",
  },
];
...
const HIGHLIGHTS = [
  ...
  },
  {
    Icon: BrainCircuit,
    title: "OrionMind",
    desc: "Converse com o mentor IA treinado nos princípios do Gabriel Dutra.",
  },
  {
    Icon: Newspaper,
    title: "Notícias + CryptoBubbles",
    desc: "Calendário macro e radar cripto, lado a lado com sua análise.",
  },
];
...
const FAQS: Array<[string, string]> = [
  [
    ...
    "Não. É um pagamento único que libera 12 meses de acesso completo. Sem renovação automática — você decide se quer renovar.",
  ],
  [
    "Tenho garantia?",
    "Sim. Você tem 7 dias após a compra como garantia de devolução. Se não gostou, devolvemos 100% do valor.",
  ],
  [
    "Como funciona o suporte?",
    "Suporte humano via Telegram oficial com prioridade na fila. Respostas tipicamente em poucas horas.",
  ],
  [
  ...
  [
    ...
    "Cartão (até 12x), Pix à vista e boleto. Acesso liberado em poucos minutos após confirmação.",
  ],
];
  ...
  return (
    <div className="mx-auto w-full max-w-4xl px-5 py-10 pb-28">
      ...
      <div className="mb-10 text-center fade-up">
        <div
          className="mb-4 inline-flex items-center gap-2 rounded-full border px-4 py-1.5 text-[10px] font-bold uppercase tracking-widest"
          style={{
        ...
        <h1 className="font-display text-4xl font-black leading-[1.05] tracking-tight md:text-5xl">
          Desbloqueie o <span className="gradient-text">OrionHub completo</span>
          <br className="hidden md:block" />
          por 12 meses
        </h1>
        <p className="mx-auto mt-4 max-w-xl text-sm text-muted-foreground md:text-base">
          Pagamento único. Sem mensalidade. Sem renovação automática. Tudo o que você precisa para
      ...
      {state.isPro ? (
        <div
          className="mb-10 rounded-3xl border p-7 text-center scale-in card-glow"
          style={{
            background:
              "linear-gradient(160deg, color-mix(in oklab, var(--green) 14%, var(--surface)), color-mix(in oklab, var(--electric) 8%, var(--surface)))",
        ...
        >
          ...
          <div className="mt-1 text-sm text-muted-foreground">
            Aproveite todos os recursos sem limites por 12 meses.
          </div>
        </div>
      ) : (
        <div
          className="mb-10 rounded-3xl border p-7 fade-up card-glow"
          style={{
            background:
              "linear-gradient(160deg, color-mix(in oklab, var(--accent) 16%, var(--surface)), var(--surface))",
        ...
        >
          <div className="flex flex-wrap items-end justify-between gap-6">
            <div>
              ...
              <div className="mt-1 text-xs text-muted-foreground">
                /ano · pagamento único · 12 meses de acesso completo
              </div>
            </div>
            <a
              href={TELEGRAM_URL}
          ...
          <div className="mt-4 flex flex-wrap items-center gap-x-4 gap-y-1 text-[11px] text-muted-foreground">
            <span className="inline-flex items-center gap-1">
              <ShieldCheck className="h-3 w-3" /> Garantia de 7 dias · 100% do valor
            </span>
            <span>·</span>
      ...
      <div className="mb-10">
        ...
        <div className="grid gap-3 sm:grid-cols-2 stagger">
          {BENEFITS.map(({ Icon, title, desc }) => (
            <div
              key={title}
              className="group flex gap-3 rounded-2xl border p-4 card-glow hover-lift"
              style={{ background: "var(--surface)", borderColor: "var(--border)" }}
            >
              <div
                className="flex h-10 w-10 flex-none items-center justify-center rounded-lg smooth group-hover:scale-110"
                style={{
                  background: "color-mix(in oklab, var(--electric) 14%, transparent)",
                  color: "var(--electric)",
                }}
              >
                <Icon className="h-5 w-5" strokeWidth={1.6} />
      ...
      {/* Promise */}
      <div
        className="mb-10 rounded-3xl border p-6 text-center fade-up"
        style={{ background: "var(--surface)", borderColor: "var(--border)" }}
      >
        <div
        ...
        <p className="mx-auto mt-4 max-w-xl text-sm italic text-muted-foreground">
          “O OrionHub é a tradução prática da metodologia que ensino dentro do Orion Capital — agora
          com IA para acelerar a leitura do gráfico e a sua gestão de banca.”
        </p>
