...
import { CheckCircle2, TrendingUp, TrendingDown, Pencil, Trash2, Trophy, Calendar, Activity, Flame, Shield } from "lucide-react";
...
export function BigStat({ label, value, accent }: { label: string; value: string; accent?: string }) {
  return (
    <div
