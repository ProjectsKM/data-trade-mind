...
const COPY: Record<
  GateKey,
  { title: string; tagline: string; description: string; Icon: LucideIcon; perks: string[] }
> = {
  scan: {
    title: "OrionScan IA",
    tagline: "Análise de gráficos com IA",
    description:
      "Envie o print do gráfico e receba direção, suporte, resistência, padrões e horário de entrada calculado.",
    Icon: LineChart,
    perks: [
      "Análises ilimitadas",
      "Leitura de candles e padrões",
      "Horário de entrada e proteções",
    ],
  },
  mind: {
    title: "OrionMind",
    ...
    description:
      "Converse com o mentor IA da Orion Capital, registre operações por voz e receba orientação estratégica em tempo real.",
    Icon: Brain,
    perks: [
      "Memória estendida da sua banca",
      "Registro de trades por chat",
      "Tutor de price action e gestão",
    ],
  },
  gestao: {
    ...
    description:
      "Acompanhe banca, payout, sequência, drawdown e exporte relatórios completos das suas operações.",
    Icon: ClipboardList,
    perks: [
      "Histórico ilimitado de trades",
  ...
  noticias: {
    ...
    description:
      "Eventos macro classificados por impacto (alto, médio e baixo) para você operar sem ser pego de surpresa.",
    Icon: Newspaper,
    perks: [
      "Eventos da semana atualizados",
      "Filtro por impacto no mercado",
      "Horários e previsões",
    ],
  },
  cryptobubbles: {
    title: "CryptoBubbles",
    ...
    description:
      "Visualize em tempo real as maiores altas, quedas e volume do mercado cripto, integrado direto na plataforma.",
    Icon: CircleDot,
  ...
  dashboard: {
    ...
    description:
      "Acompanhe sua banca, performance, métricas-chave e o panorama completo das suas operações num único lugar.",
  ...
  calculadora: {
    ...
    description:
      "Calcule entradas, proteções, payouts e stop loss/win usando a metodologia padrão Orion para preservar sua banca.",
    Icon: Calculator,
    perks: [
      "Cálculo automático de proteções",
      "Padrão Orion configurado",
      "Simulação por payout e ativo",
    ],
  },
};
    ...
    <div className="relative h-full min-h-0">
      ...
      >
        ...
        >
          ...
          <div
            className="mt-3 inline-flex items-center gap-2 rounded-full border px-4 py-1.5 text-sm font-black"
            style={{
